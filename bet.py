...
st.write("The aim is to win 5 bets on the trot, but only 2 need to win to show a banked return. The most you can lose is the initial stake.")
...
if odds_input:
    ...
    st.write(f"Bet the full amount ({stake}) on the selection.")
    ...
    if result == "Lost":
        ...
        if odds_input2:
            ...
            st.write(f"Bet the full amount ({stake2}) on the selection.")
            ...
            if result2 == "Lost":
                ...
                if odds_input3:
                    ...
                    st.write(f"Bet the full amount ({stake3}) on the selection.")
                    ...
                    if result3 == "Lost":
                        st.write("Better luck next time.")
                        net_loss = calc_net_profit(banked, stake)
                        st.write(f"Net loss (taking into account initial stake and banked amount): {net_loss}")
                    elif result3 == "Won":
                        ...
                        if odds_input4:
                            ...
                            st.write(f"Bet the full amount ({stake4}) on the selection.")
                            ...
                            if result4 == "Lost":
                                st.write("Better luck next time.")
                                net_loss = calc_net_profit(banked + banked2, stake)
                                st.write(f"Net loss (taking into account initial stake and banked amounts): {net_loss}")
                            elif result4 == "Won":
                                ...
                                odds_input5 = st.text_input("Please enter the odds for Bet 5 (as a decimal or fraction)")
                                
                                if odds_input5:
                                    odds5 = odds_to_decimal(odds_input5)
                                    
                                    st.write(f"Bet the full amount ({stake5}) on the selection.")
                                    ...
                                    if result5 == "Lost":
                                        st.write("Better luck next time.")
                                        net_loss = calc_net_profit(banked + banked2 + banked3, stake)
                                        st.write(f"Net loss (taking into account initial stake and banked amounts): {net_loss}")
                                    elif result5 == "Won":
                                        ...
                                        st.write(f"Net profit (taking into account initial stake and banked amounts): {net_profit}")
